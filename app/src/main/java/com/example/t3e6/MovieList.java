...
public class MovieList {
    ...
    private static ArrayList<Movie> createList() {
        ...
        dune.setMovieName("Dune");
        dune.setDirectorName("Lynch");
        dune.setMinutes(180);
        dune.setReleaseDate(cal.getTime());
        dune.setTheaterName("Gran vía"); //R.drawable.g,R.drawable.dune );
        dune.setAgeRating(Movie.AgeRating.G);
        dune.setCoverId(R.drawable.dune);
        dune.setYoutubeId("oHg5SJYRHA0");
        dune.setSummary(
                "Por orden imperial, la familia Atreides deberá hacerse cargo de la explotación del desértico planeta de Arrakis, conocido también como \"Dune\" " +
        ...
        cal.set(1972,3,5);
        Movie a2001 = new Movie();
        a2001.setMovieName("2001");
        a2001.setDirectorName("Kubric");
        a2001.setMinutes(130);
        a2001.setReleaseDate(cal.getTime());
        a2001.setTheaterName("Plaza elíptica");
        a2001.setAgeRating(Movie.AgeRating.PG);
        a2001.setCoverId(R.drawable.d2001);
        a2001.setYoutubeId("oHg5SJYRHA0");
        a2001.setSummary(
                "La secuencia inicial del filme se inicia con la imagen de la Tierra ascendiendo sobre la Luna, mientras que el Sol asciende a su vez sobre la " +
        ...
        akira.setMovieName("Akira");
        akira.setDirectorName("Otomo");
        akira.setMinutes(170);
        akira.setReleaseDate(cal.getTime());
        akira.setTheaterName("Gran vía");
        akira.setAgeRating(Movie.AgeRating.PG13);
        akira.setCoverId(R.drawable.akira);
        akira.setYoutubeId("oHg5SJYRHA0");
        akira.setFavorite(true);
        akira.setSummary(
                "Neo-Tokyo, 2019. Shotaro Kaneda sale junto con su pandilla de motociclistas (\"Los Cápsulas\") a pelear contra un pandilla rival conocida como Los" +
        ...
        Movie ia = new Movie();
        ia.setMovieName("IA");
        ia.setDirectorName("Spielberg");
        ia.setMinutes(140);
        ia.setReleaseDate(cal.getTime());
        ia.setTheaterName("Travesía");
        ia.setAgeRating(Movie.AgeRating.R_);
        ia.setCoverId(R.drawable.ia);
        ia.setYoutubeId("oHg5SJYRHA0");
        ia.setSummary(
                "A mediados del siglo XXI, el calentamiento global provocó que las capas de hielo de los polos se derritieran, inundaran las costas y se redujera " +
        ...
        matrix.setMovieName("Matrix");
        matrix.setDirectorName("Lana Wachowski, Lilly Wachowski");
        matrix.setMinutes(136);
        matrix.setReleaseDate(cal.getTime());
        matrix.setTheaterName("Gran vía");
        matrix.setAgeRating(Movie.AgeRating.PG13);
        matrix.setCoverId(R.drawable.matrix);
        matrix.setYoutubeId("oHg5SJYRHA0");
        matrix.setSummary(
                "La película plantea que en el futuro, casi todos los seres humanos han sido esclavizados, tras una dura guerra, por las máquinas y las " +
        ...
        cal.set(1982,8,21);
        Movie br=new Movie();
        br.setMovieName("Blade Runner");
        br.setDirectorName("Ridley Scott");
        br.setMinutes(117);
        br.setReleaseDate(cal.getTime());
        br.setTheaterName("Plaza elíptica");
        br.setAgeRating(Movie.AgeRating.PG);
        br.setCoverId(R.drawable.blade);
        br.setYoutubeId("oHg5SJYRHA0");
        br.setSummary(
                "En la ciudad de Los Ángeles, en noviembre de 2019, Rick Deckard (Harrison Ford) es llamado de su retiro cuando un Blade Runner excesivamente " +
        ...
        cal.set(1995,1,2);
        Movie inte=new Movie();
        inte.setMovieName("Interstellar");
        inte.setDirectorName("Christopher Nolan");
        inte.setMinutes(169);
        inte.setReleaseDate(cal.getTime());
        inte.setTheaterName("Travesía");
        inte.setAgeRating(Movie.AgeRating.R_);
        inte.setCoverId(R.drawable.interstellar);
        inte.setYoutubeId("oHg5SJYRHA0");
        ...
        alien.setMovieName("Alien");
        alien.setDirectorName("Ridley Scott");
        alien.setMinutes(117);
        alien.setReleaseDate(cal.getTime());
        alien.setTheaterName("Plaza elíptica");
        alien.setAgeRating(Movie.AgeRating.PG13);
        alien.setCoverId(R.drawable.alien);
        alien.setYoutubeId("oHg5SJYRHA0");
        alien.setSummary(
                "La nave espacial de transporte comercial U.S.C.S.S. Nostromo regresa a la Tierra proveniente del planeta ficticio Thedus,nota 1 con un remolque " +
        ...
        cal.set(1995,1,2);
        Movie st = new Movie();
        st.setMovieName("Star Trek");
        st.setDirectorName("J. J. Abrams");
        st.setMinutes(128);
        st.setReleaseDate(cal.getTime());
        st.setTheaterName("Travesía");
        st.setAgeRating(Movie.AgeRating.PG);
        st.setCoverId(R.drawable.startrek);
        st.setYoutubeId("oHg5SJYRHA0");
        st.setSummary(
                "La nave espacial de la Federación USS Kelvin explora un fenómeno astrofísico similar a una tormenta eléctrica, que produce un agujero negro. De este" +
        ...
        martian.setMovieName("The Martian");
        martian.setDirectorName("Ridley Scotts");
        martian.setMinutes(151);
        martian.setReleaseDate(cal.getTime());
        martian.setTheaterName("Gran vía");
        martian.setAgeRating(Movie.AgeRating.PG13);
        martian.setCoverId(R.drawable.martian);
        martian.setYoutubeId("oHg5SJYRHA0");
        martian.setSummary("Durante una misión a Marte de la nave tripulada Ares III, una fuerte tormenta se desata, por lo que, tras haber dado por desaparecido y muerto al astronauta Mark Watney (Matt Damon), sus compañeros toman la decisión de irse; sin embargo, ha sobrevivido, pero está solo y sin apenas recursos en el planeta. Con muy pocos medios, deberá recurrir a sus conocimientos, su sentido del humor y un gran instinto de supervivencia para lograr sobrevivir y comunicar a la Tierra que todavía está vivo, esperando que acudan en su rescate.");
        movies.add(martian);
